...
def test_whole_word_precheck_chol():
    """chol should match whole-word as flour/grain (CONFIRMED in lexicon)."""
    ...
    print(f"  chol -> {result.stem_gloss} (whole-word match)")
