...
<img src="https://collections.library.yale.edu/iiif/2/1006168/full/600,/0/default.jpg" width="500" alt="Folio f48r of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f48r. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
CRO: pšdaiin yphdy ophey csty dal šeodaiin šeosteol ysteeody olaiin opaldy
EXP: pšd+aiin i+dy oph+ey stare+y DA/DARE [Lat.] šeo-d+aiin šeo-stare+ol i+dy ulje+aiin tekućina+dy
ENG: [liquid+continuing] and/with [verbal] [participle] +?oph Stand / place / position [adjective] GIVE (RX IMPERATIVE) +l Soaked-state (extended) [liquid+continuing] Soaked-state (extended) Stand / place / position [instrumental] and/with [verbal] +?steeo oil [liquid+continuing] liquid/water (vessel context) [verbal]
```
<sub>[▓▓▓▓▓▓░░░░] 68% confidence</sub>

```
EVA: daiin yteeol choody kechodshey qotedy chtaiin otchdy tedain okain ckhy
CRO: daiin yteeol hoody stehodšey kotedy htaiin othdy tedain ostain csty
EXP: DA/DARE [Lat.] i+ol kuhaj-oo+dy stare+ey ko-t+edy kuhaj-t+aiin posuda-h+dy radix + facere+ain OSTEO- [Lat.] stare+y
ENG: GIVE (RX IMPERATIVE) +i and/with [instrumental] combine/cook (reduced) [verbal] Stand / place / position [participle] +?ehodš measure/quantify (variant) [verbal] combine/cook (reduced) [liquid+continuing] vessel/container (variant) [verbal] "Process kernel / do / treat" [plural] BONE (MEDICAL REGISTER) Stand / place / position [adjective]
```
...
CRO: alšey lsteedy ythedy kostedy lotal kotol otal hed ostey ysteey dalmy
EXP: tekućina+ey l-stare+edy i+edy ko-stare+edy l-ot+al ko-t+ol posuda-tekućina he-d OSTEO- [Lat.] i+ey DA/DARE [Lat.]
ENG: liquid/water (vessel context) [participle] The / that (determiner) Stand / place / position [verbal] and/with [verbal] measure/quantify (variant) Stand / place / position [verbal] The / that (determiner) [locative] measure/quantify (variant) [instrumental] vessel/container (variant) liquid/water (vessel context) State / Result / After BONE (MEDICAL REGISTER) and/with [participle] GIVE (RX IMPERATIVE) +lm
```
...
CRO: othdain šol oteol oteoly ysteey dam dr
EXP: posuda-hd+ain namoci-ulje posuda-e+ol posuda-ulje+y i+ey DA/DARE [Lat.] dr
ENG: vessel/container (variant) [plural] soak/infuse (Croatian) oil vessel/container (variant) [instrumental] vessel/container (variant) oil [adjective] and/with [participle] GIVE (RX IMPERATIVE) +m ?dr?
```
<sub>[▓▓▓▓▓▓░░░░] 64% confidence</sub>

```
EVA: yteched ar alkey okeoam
CRO: ytehed ar alstey osteoam
EXP: i voda tekućina+ey OSTEO- [Lat.]
ENG: and/with +?tehed water liquid/water (vessel context) [participle] BONE (MEDICAL REGISTER) +eoa
```
