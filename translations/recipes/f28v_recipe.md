...
<img src="https://collections.library.yale.edu/iiif/2/1006129/full/600,/0/default.jpg" width="500" alt="Folio f28v of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f28v. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
CRO: otol hol daiin hstaiin šoiin kothey kotšey daiiin
EXP: posuda-ulje kuhaj-ulje DA/DARE [Lat.] kuhaj-stare+aiin namoci-o+iin ko-th+ey ko-tš+ey DA/DARE [Lat.]
ENG: vessel/container (variant) oil combine/cook (reduced) oil GIVE (RX IMPERATIVE) +i combine/cook (reduced) Stand / place / position [liquid+continuing] soak/infuse (Croatian) [continuation] measure/quantify (variant) [participle] measure/quantify (variant) [participle] GIVE (RX IMPERATIVE) +i
```
...
EVA: daiin chkaiin
CRO: daiin hstaiin
EXP: DA/DARE [Lat.] kuhaj-stare+aiin
ENG: GIVE (RX IMPERATIVE) +i combine/cook (reduced) Stand / place / position [liquid+continuing]
```
<sub>[█████████░] 90% confidence</sub>

```
EVA: pchol aiir chol tsho daiin shotco chychtshy daiis am
CRO: phol aiir hol tšo daiin šotco hyhtšy daiis am
EXP: ph+ol ai+ir kuhaj-ulje tšo DA/DARE [Lat.] namoci-otco kuhaj-i+y DA/DARE [Lat.] a+m
ENG: [instrumental] [agent] combine/cook (reduced) oil ?tšo? GIVE (RX IMPERATIVE) +i soak/infuse (Croatian) +?otco combine/cook (reduced) and/with [adjective] GIVE (RX IMPERATIVE) +ii [case]
```
...
EXP: s-r he-voda kuhaj-l s kuhaj-ulje+y DA/DARE [Lat.]
ENG: with/together (variant) State / Result / After water combine/cook (reduced) ?s? combine/cook (reduced) oil [adjective] GIVE (RX IMPERATIVE) +r
```
