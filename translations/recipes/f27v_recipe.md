...
EXP: fohof kuhaj-of kuhaj-o namoci-o s-l+y namoci-ulje i kuhati+y stare
ENG: ?fohof? combine/cook (reduced) +?of combine/cook (reduced) soak/infuse (Croatian) with/together (variant) [adjective] soak/infuse (Croatian) oil and/with +?thor cook/combine [adjective] Stand / place / position +?horhor
```
...
EXP: stare+ey stare+y kost+y dšo dh+ir kuhaj-stabljika+y ono što+dy namoci-ld
ENG: Stand / place / position [participle] Stand / place / position [adjective] bone [adjective] ?dšo? [agent] combine/cook (reduced) stalk/stem [adjective] that which/the one [verbal] soak/infuse (Croatian) +?ld
```
...
EXP: ko-stare+y namoci-stare namoci-stabljika+ar namoci-stare+y smjesa+ol
ENG: measure/quantify (variant) Stand / place / position [adjective] soak/infuse (Croatian) Stand / place / position soak/infuse (Croatian) stalk/stem [instrumental] soak/infuse (Croatian) Stand / place / position [adjective] +?olhoth compound mixture [instrumental]
```
...
*Generated by ZFD Decoder v2.0 | Unified Lexicon v3.0.0 (362 morphemes) | f27v*