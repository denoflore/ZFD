...
<img src="https://collections.library.yale.edu/iiif/2/1006109/full/600,/0/default.jpg" width="500" alt="Folio f18v of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f18v. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
CRO: told šar ytšy othdal dhal dhy ytdg
EXP: ulje namoci-voda i+y posuda-hd+al dh+al dh+y i
ENG: oil soak/infuse (Croatian) water and/with [adjective] vessel/container (variant) [locative] [locative] [adjective] +?dh and/with +?tdg
```
...
CRO: kothy kostay kosthy ystho ydl dar
EXP: ko-th+y ko-stare+y ko-stare+y i i DA/DARE [Lat.]
ENG: measure/quantify (variant) [adjective] measure/quantify (variant) Stand / place / position [adjective] measure/quantify (variant) Stand / place / position [adjective] and/with +?stho and/with +?dl GIVE (RX IMPERATIVE) +r
```
<sub>[▓▓▓▓▓░░░░░] 58% confidence</sub>

```
EVA: r ychoees ykchy qol kchy qotchol daiir om
CRO: r yhoees ysthy kol sthy kothol daiir om
EXP: r i+s i+y ko-l stare+y ko-th+ol DA/DARE [Lat.] o+m
ENG: ?r? and/with [~15] +?hoee and/with [adjective] +?sth measure/quantify (variant) Stand / place / position [adjective] measure/quantify (variant) [instrumental] GIVE (RX IMPERATIVE) +i [case]
```
...
CRO: tolol š cplloy daror ddy ytor ystam
EXP: ulje+ol š cpllo+y DA/DARE [Lat.] d+dy i i+m
ENG: oil [instrumental] ?š? [adjective] +?cpllo GIVE (RX IMPERATIVE) +r [verbal] and/with +?tor and/with [case] +?sta
```
...
EXP: i dš+y DA/DARE [Lat.] i+ol d+om
ENG: and/with +?sta [adjective] +?dš GIVE (RX IMPERATIVE) +ir and/with [instrumental] [case]
```
