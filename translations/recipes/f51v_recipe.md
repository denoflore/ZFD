...
<p align="center">
<a href="https://collections.library.yale.edu/iiif/2/1006175/full/full/0/default.jpg">
<img src="https://collections.library.yale.edu/iiif/2/1006175/full/600,/0/default.jpg" width="500" alt="Folio f51v of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f51v. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
CRO: pošody kostodar seodaiin kotaldšheey saiindy
EXP: pošo+dy ko-stare+ar stabljika+aiin ko-tekućina+ey s-iin+dy
ENG: [verbal] +?pošo measure/quantify (variant) Stand / place / position [instrumental] stalk/stem [liquid+continuing] measure/quantify (variant) liquid/water (vessel context) [participle] with/together [verbal]
```
...
CRO: kotol hodaiin kostheody ho r hodyctrrol s olheety
EXP: ko-t+ol kuhaj-stabljika+aiin ko-stare+dy kuhaj-o r kuhaj-stabljika+ol s ulje+y
ENG: measure/quantify (variant) [instrumental] combine/cook (reduced) stalk/stem [liquid+continuing] measure/quantify (variant) Stand / place / position [verbal] combine/cook (reduced) ?r? combine/cook (reduced) stalk/stem [instrumental] ?s? oil [adjective] +?heet
```
<sub>[▓▓▓▓░░░░░░] 49% confidence</sub>

```
EVA: olkeeody qokal qodaiin ykhor yfal
CRO: olsteeody kostal kodaiin ysthor yfal
EXP: ulje+dy ko-stare+al ko-d+aiin i i+al
ENG: oil [verbal] +?steeo measure/quantify (variant) Stand / place / position [locative] measure/quantify (variant) [liquid+continuing] and/with +?sthor and/with [locative]
```
<sub>[▓▓▓▓▓▓░░░░] 64% confidence</sub>
...
CRO: yheosty šeey ysteey hey
EXP: i+y še-e+y i+ey he-i
ENG: and/with [adjective] +?heost Soaked-state / After soaking [adjective] and/with [participle] State / Result / After and/with
```
<sub>[▓▓▓▓▓▓░░░░] 64% confidence</sub>

```
EVA: ochockhy daiin chockhey
CRO: ohocsty daiin hocstey
EXP: stare+y DA/DARE [Lat.] kuhaj-stare+ey
ENG: Stand / place / position [adjective] +?ohoc GIVE (RX IMPERATIVE) +i combine/cook (reduced) Stand / place / position [participle]
```
<sub>[▓▓▓▓▓▓░░░░] 65% confidence</sub>

```
EVA: daiin cheol cheodain
CRO: daiin heol heodain
EXP: DA/DARE [Lat.] heo-l heo-d+ain
ENG: GIVE (RX IMPERATIVE) +i State / Result (extended) State / Result (extended) [plural]
```
<sub>[████████░░] 80% confidence</sub>
