...
<p align="center">
<a href="https://collections.library.yale.edu/iiif/2/1006186/full/full/0/default.jpg">
<img src="https://collections.library.yale.edu/iiif/2/1006186/full/600,/0/default.jpg" width="500" alt="Folio f57r of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f57r. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
CRO: poeeo cstey odain heop šeody šocplley dy šeep heody yodam
EXP: ee stare+ey stabljika+ain heo-p šeo-d+y namoci-ocpll+ey d+y še-ep heo-d+y i+m
ENG: (intensifier) +?poo Stand / place / position [participle] stalk/stem [plural] State / Result (extended) Soaked-state (extended) [adjective] soak/infuse (Croatian) [participle] +?ocpll [adjective] Soaked-state / After soaking State / Result (extended) [adjective] and/with [case] +?oda
```
<sub>[▓▓▓▓▓▓░░░░] 63% confidence</sub>

```
EVA: daiir air chety cheo ckhy chockhy cheotey shkchey s odaiin shey
CRO: daiir air hety heo csty hocsty heotey šsthey s odaiin šey
EXP: DA/DARE [Lat.] a+ir he-t+y he-o stare+y kuhaj-stare+y heo-t+ey namoci-stare+ey s stabljika+aiin še-i
ENG: GIVE (RX IMPERATIVE) +i [agent] State / Result / After [adjective] State / Result / After Stand / place / position [adjective] combine/cook (reduced) Stand / place / position [adjective] State / Result (extended) [participle] soak/infuse (Croatian) Stand / place / position [participle] ?s? stalk/stem [liquid+continuing] Soaked-state / After soaking and/with
```
...
CRO: tair šeedy lhedy csthdyosthy hedy dal kostedam
EXP: ta+ir še-e+dy lh-e+dy —+y he-d+y DA/DARE [Lat.] ko-stare+m
ENG: [agent] Soaked-state / After soaking [verbal] The (before h-) [verbal] Complex cluster [adjective] +?dyosth State / Result / After [adjective] GIVE (RX IMPERATIVE) +l measure/quantify (variant) Stand / place / position [case]
```
...
CRO: kocthey stedy šedaiins heos ysteos kctrrhy tcplly
EXP: ko-cth+ey stare+edy še-dare+s heo-s i+s k+y zagrij-pll+y
ENG: measure/quantify (variant) [participle] Stand / place / position [verbal] Soaked-state / After soaking Add (extended) [~15] State / Result (extended) and/with [~15] +?steo vessel (short) [adjective] +?ctrrh heat-treat (compound) [adjective]
```
<sub>[▓▓▓▓▓▓░░░░] 63% confidence</sub>

```
EVA: dshedy ctechy cphedom
CRO: dšedy ctehy cplledom
EXP: dš+edy cteh+y radix + facere+om
ENG: [verbal] [adjective] +?cteh "Process kernel / do / treat" [case]
```
