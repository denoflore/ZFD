...
ENG: oil +?tor combine/cook (reduced) bone [adjective] combine/cook (reduced) [continuation] BONE (MEDICAL REGISTER) +š oil [adjective] BONE (MEDICAL REGISTER)
```
...
EXP: OSTEO- [Lat.] kuhaj-stabljika+iin posuda-a+iin posuda-a+iin smjesa+ar
ENG: BONE (MEDICAL REGISTER) +se combine/cook (reduced) stalk/stem [continuation] vessel/container (variant) [continuation] vessel/container (variant) [continuation] compound mixture [instrumental]
```
...
ENG: measure/quantify (variant) storax BONE (MEDICAL REGISTER) +inot measure/quantify (variant) Stand / place / position [instrumental] combine/cook (reduced) bone +?ostor
```
...
EXP: OSTEO- [Lat.] he-i stare smjesa DA/DARE [Lat.] ulje+dy
ENG: BONE (MEDICAL REGISTER) +or State / Result / After and/with Stand / place / position +?ainhor compound mixture GIVE (RX IMPERATIVE) +in oil [verbal]
```
...
EXP: i namoci-o stare+aiin OSTEO- [Lat.] kuhaj-kuhati DA/DARE [Lat.]
ENG: and/with +?šo soak/infuse (Croatian) Stand / place / position [liquid+continuing] BONE (MEDICAL REGISTER) +o combine/cook (reduced) cook/combine GIVE (RX IMPERATIVE) +i
```
<sub>[▓▓▓▓▓▓░░░░] 65% confidence</sub>

---

*Generated by ZFD Decoder v2.0 | Unified Lexicon v3.0.0 (362 morphemes) | f38r*