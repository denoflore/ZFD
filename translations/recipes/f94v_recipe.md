...
<img src="https://collections.library.yale.edu/iiif/2/1006241/full/600,/0/default.jpg" width="500" alt="Folio f94v of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f94v. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
CRO: tšedy hedar har kosthedy ostal darophaisthy oteedan
EXP: tš+edy he-d+ar kuhaj-voda ko-stare+edy OSTEO- [Lat.] DA/DARE [Lat.] posuda-ee+an
ENG: [verbal] State / Result / After [instrumental] combine/cook (reduced) water measure/quantify (variant) Stand / place / position [verbal] BONE (MEDICAL REGISTER) GIVE (RX IMPERATIVE) +rophaih vessel/container (variant) (intensifier) [adjective]
```
<sub>[███████░░░] 79% confidence</sub>

```
EVA: ol teedy oteey qekeey oteey teedalykeedy qotar ain
CRO: ol teedy oteey kesteey oteey teedalysteedy kotar ain
EXP: ulje te+edy posuda-e+ey k+ey posuda-e+ey dal+edy ko-t+ar a+in
ENG: oil [verbal] vessel/container (variant) [participle] vessel (short) [participle] +?este vessel/container (variant) [participle] da-l-al [verbal] +?teeyste measure/quantify (variant) [instrumental] [plural]
```
<sub>[███████░░░] 70% confidence</sub>

```
EVA: yshedy chdaiin otedy sdal tam dyeedy qokeey tam
CRO: yšedy hdaiin otedy sdal tam dyeedy kosteey tam
EXP: i+edy kuhaj-d+aiin posuda-e+dy sd+al ta+m i+edy ko-stare+ey ta+m
ENG: and/with [verbal] combine/cook (reduced) [liquid+continuing] vessel/container (variant) [verbal] [locative] [case] +?ta and/with [verbal] measure/quantify (variant) Stand / place / position [participle] [case] +?ta
```
<sub>[▓▓▓▓▓▓░░░░] 64% confidence</sub>

```
EVA: dchdy otar otchy kedy qokchdy olokchy
CRO: dhdy otar othy stedy kosthdy olosthy
EXP: dh+dy posuda-voda posuda-h+y stare+edy ko-stare+dy ulje+y
ENG: [verbal] vessel/container (variant) water vessel/container (variant) [adjective] Stand / place / position [verbal] measure/quantify (variant) Stand / place / position [verbal] oil [adjective] +?osth
```
...
CRO: ytar ostedy osteedy kostšey otaiin yyphdair ol s aiin oly
EXP: i+ar OSTEO- [Lat.] OSTEO- [Lat.] ko-stare+ey posuda-a+iin i+ir ulje s a+iin ulje+y
ENG: and/with [instrumental] BONE (MEDICAL REGISTER) BONE (MEDICAL REGISTER) +e measure/quantify (variant) Stand / place / position [participle] vessel/container (variant) [continuation] and/with [agent] +?yphda oil ?s? [continuation] oil [adjective]
```
<sub>[███████░░░] 74% confidence</sub>

```
EVA: ol air cheey okchaiin shy tar ar aiinotody qodar oteey dar
CRO: ol air heey osthaiin šy tar ar aiinotody kodar oteey dar
EXP: ulje a+ir he-e+y OSTEO- [Lat.] namoci-i t+ar voda iterum+dy ko-d+ar posuda-e+ey DA/DARE [Lat.]
ENG: oil [agent] State / Result / After [adjective] BONE (MEDICAL REGISTER) +h soak/infuse (Croatian) and/with [instrumental] water Repetition / plural [verbal] measure/quantify (variant) [instrumental] vessel/container (variant) [participle] GIVE (RX IMPERATIVE) +r
```
