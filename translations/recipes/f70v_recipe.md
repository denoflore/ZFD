...
<p align="center">
<a href="https://collections.library.yale.edu/iiif/2/1006201/full/full/0/default.jpg">
<img src="https://collections.library.yale.edu/iiif/2/1006201/full/600,/0/default.jpg" width="500" alt="Folio f70v of the Voynich Manuscript (Beinecke MS 408)">
</a>
<br><sub>Folio f70v. Beinecke MS 408. Click for full resolution. Image: Yale Beinecke Library (public domain).</sub>
</p>
...
|----------|---------|-------------|
| **ot-** | vessel/container (variant) | 67 |
| **da-** | dose/add/give | 19 |
...
CRO: otylal
EXP: posuda-i+al
ENG: vessel/container (variant) and/with [locative]
```
<sub>[████████░░] 83% confidence</sub>

```
EVA: otalchy tar am dy
CRO: otalhy tar am dy
EXP: posuda-tekućina+y t+ar a+m d+y
ENG: vessel/container (variant) liquid/water (vessel context) [adjective] [instrumental] [case] [adjective]
```
...
CRO: osty ody
EXP: OSTEO- [Lat.] o+dy
ENG: BONE (MEDICAL REGISTER) [verbal]
```
<sub>[████████░░] 83% confidence</sub>
...
EVA: otal dar
CRO: otal dar
EXP: posuda-tekućina DA/DARE [Lat.]
ENG: vessel/container (variant) liquid/water (vessel context) GIVE (RX IMPERATIVE) +r
```
<sub>[████████░░] 83% confidence</sub>
...
EVA: otal rar
CRO: otal rar
EXP: posuda-tekućina r+ar
ENG: vessel/container (variant) liquid/water (vessel context) [instrumental]
```
<sub>[████████░░] 83% confidence</sub>
...
CRO: otar
EXP: posuda-voda
ENG: vessel/container (variant) water
```
<sub>[██████████] 100% confidence</sub>
...
CRO: hedaiin othy dair šhey daiin halaly oteody hotol hedy oteatey otheor ar alody daiir oteedar othy thy dal al heoltey oteedy šeeteey šs steeol ysteeos šey ostear ar ar alos daimdy otar am ar al otard
EXP: he-d+aiin posuda-h+y DA/DARE [Lat.] namoci-i DA/DARE [Lat.] kuhaj-tekućina+y posuda-eo+dy kuhaj-ot+ol he-d+y posuda-eat+ey posuda-r voda tekućina+dy DA/DARE [Lat.] posuda-ee+ar posuda-h+y th+y DA/DARE [Lat.] tekućina heo-lt+ey posuda-e+edy še-ete+ey namoci-s stare+ol i+s še-i OSTEO- [Lat.] voda voda tekućina+s DA/DARE [Lat.] posuda-voda a+m voda tekućina posuda-voda
ENG: State / Result / After [liquid+continuing] vessel/container (variant) [adjective] GIVE (RX IMPERATIVE) +ir soak/infuse (Croatian) (state/result/after) and/with GIVE (RX IMPERATIVE) +i combine/cook (reduced) liquid/water (vessel context) [adjective] vessel/container (variant) [verbal] combine/cook (reduced) [instrumental] State / Result / After [adjective] vessel/container (variant) [participle] vessel/container (variant) (state/result (extended)) water liquid/water (vessel context) [verbal] GIVE (RX IMPERATIVE) +i vessel/container (variant) (intensifier) [instrumental] vessel/container (variant) [adjective] [adjective] +?th GIVE (RX IMPERATIVE) +l liquid/water (vessel context) State / Result (extended) [participle] vessel/container (variant) [verbal] Soaked-state / After soaking [participle] soak/infuse (Croatian) Stand / place / position [instrumental] and/with [~15] +?steeo Soaked-state / After soaking and/with BONE (MEDICAL REGISTER) +e water water liquid/water (vessel context) [~15] GIVE (RX IMPERATIVE) +im vessel/container (variant) water [case] water liquid/water (vessel context) vessel/container (variant) water
```
...
CRO: otaral
EXP: posuda-voda+al
ENG: vessel/container (variant) water [locative]
```
<sub>[██████████] 100% confidence</sub>
...
CRO: ophey sal
EXP: oph+ey s-l
ENG: [participle] +?oph with/together
```
...
CRO: oalheg
EXP: tekućina
ENG: liquid/water (vessel context) +?oheg
```
...
CRO: othodals
EXP: posuda-dal+s
ENG: vessel/container (variant) da-l-al [~15]
```
<sub>[███████░░░] 75% confidence</sub>
...
EVA: otol ypsharal
CRO: otol ypšaral
EXP: posuda-ulje i+al
ENG: vessel/container (variant) oil and/with [locative] +?pšar
```
<sub>[███████░░░] 71% confidence</sub>
...
EVA: otolaiin
CRO: otolaiin
EXP: posuda-ulje+aiin
ENG: vessel/container (variant) oil [liquid+continuing]
```
<sub>[██████████] 100% confidence</sub>
...
CRO: oteoeey otal osteal ar
EXP: posuda-eoe+ey posuda-tekućina OSTEO- [Lat.] voda
ENG: vessel/container (variant) [participle] vessel/container (variant) liquid/water (vessel context) BONE (MEDICAL REGISTER) +e water
```
...
EVA: oteas araydy
CRO: oteas araydy
EXP: posuda-ea+s voda+dy
ENG: vessel/container (variant) [~15] water [verbal]
```
